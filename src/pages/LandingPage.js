          ...
          <Col md={6}>
            <div className='tech__right text-center'>
              ...
              <p className='px-3'>
                ...
                working as a team. We plan to create more projects together in
                the near future, so if you liked this one, feel free to follow
                us on github to see what we're working on next!
              </p>
            </div>
          </Col>
